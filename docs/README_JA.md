...
- [tongflow-router-toapis](https://github.com/tong-io/tongflow-router-toapis) — ToAPIs 集約ゲートウェイ、ノードごとの**モデルピッカー**付き：`gen_text` / テキストツール（GPT-5.6、Claude、Gemini、DeepSeek、Qwen、GLM、Kimi、MiniMax）、画像理解、画像生成/編集/融合（GPT Image 2、Seedream 5、Gemini Image、Flux 2、Grok）、テキスト / 画像 → 動画（Sora 2、Veo 3.1、Seedance 2、Kling、MiniMax H3、Wan、HappyHorse、Vidu）、動画編集（HappyHorse）
