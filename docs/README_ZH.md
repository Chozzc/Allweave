...
- [tongflow-router-toapis](https://github.com/tong-io/tongflow-router-toapis) — ToAPIs 聚合网关，按节点**模型选择**：`gen_text` / 文本工具（GPT-5.6、Claude、Gemini、DeepSeek、Qwen、GLM、Kimi、MiniMax）、图像理解、图像生成/编辑/融合（GPT Image 2、Seedream 5、Gemini Image、Flux 2、Grok）、文 / 图 → 视频（Sora 2、Veo 3.1、Seedance 2、Kling、MiniMax H3、Wan、HappyHorse、Vidu）、视频编辑（HappyHorse）
