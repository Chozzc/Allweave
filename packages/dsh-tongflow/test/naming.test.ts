...
describe("naming", () => {
    it("builds and parses episode/scene/shot ids", () => {
        ...
        expect(shotSortKey("EP01_SC002_SH0010")).toBeLessThan(
            shotSortKey("EP01_SC002_SH0020"),
        );
        expect(shotSortKey("EP01_SC009_SH0990")).toBeLessThan(
            shotSortKey("EP02_SC001_SH0010"),
        );
    });
    ...
    it("classifies owners and passes", () => {
        ...
        expect(() => assertPassForOwner("CHR_MEI", "KF")).toThrow(
            /does not belong/,
        );
    ...
    it("formats and parses take file names", () => {
        expect(takeFileName("EP01_SC003_SH0010", "KF", "T02", ".PNG")).toBe(
            "EP01_SC003_SH0010_KF_T02.png",
        );
        ...
        expect(
            parseTakeFileName("CHR_MEI_REF_T01.provenance.json"),
        ).toBeUndefined();
