...
export type StudioLauncherProps = PropsRuntime<"sidebar.footer.action"> & StudioInjected;
    ...
    return (
        <>
            ...
            >
                ...
                {props.wide ? <span className="tfs-launch-label">Studio</span> : null}
            </button>
            {open
                ? createPortal(
                      <div className="tfs-overlay">
                          <StudioView useSessions={props.useSessions} openWorkspace={props.openWorkspace} locale={props.locale} onClose={() => setOpen(false)} />
                      </div>,
                      document.body,
                  )
                : null}
